...
";
echo "<script type=\"text/javascript\" src=\"{$_FN['siteurl']}themes/{$_FN['theme']}/sugar_30.js\"></script>
<script type=\"text/javascript\" src=\"{$_FN['siteurl']}themes/{$_FN['theme']}/cookie00.js\"></script>
";
echo "
<script type=\"text/javascript\" language=\"javascript\" src=\"{$_FN['siteurl']}themes/{$_FN['theme']}/menu0000.js\"></script>
<script type=\"text/javascript\" language=\"javascript\" src=\"{$_FN['siteurl']}themes/{$_FN['theme']}/cookie01.js\"></script>
";
...
function hideLeftCol(id){
	...
	if(this.document.getElementById( id).style.display=='none'){
		...
		document['HideHandle'].src = '{$_FN['siteurl']}themes/{$_FN['theme']}/images/hide.gif';
	}else{
		this.document.getElementById(  id).style.display='none';

		Set_Cookie('showLeftCol','false',30,'/','','');
		var show = Get_Cookie('showLeftCol');
		document['HideHandle'].src = '{$_FN['siteurl']}themes/{$_FN['theme']}/images/show.gif';
...
<body onMouseOut="closeMenus();">
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="180"
            ...
            <tr>
                <th width="5" valign="top"><img
                        src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/moduleTb.gif"
                        alt="Scorciatoie" width="5" height="23" border="0"></th>
                <th width="100%" class="leftColumnModuleName">Menu</th>
                <th width="7" valign="top"><img
                        src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/moduleTc.gif"
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td width="80%" height="40" rowspan="2" valign="top"><img
                                src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/company_.png"
                        ...
                        <td rowspan="2" align="right" valign="top" style="border: none;"><img
                                src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/myAreaSe.gif"
                    ...
                    <tr>
                        <td align="right" style="height: 20px"><img
                                src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/sugarsal.png"
                    ...
                    <tr>
                        <td colspan="3" ><table style="background-color:transparent" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                        ...
                                        <table <?php echo $st?> cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr style="height: 25px">
                                                <td valign="bottom" style="background-image : url(themes/<?php echo $_FN ['theme']?>/images/emptyTabSpace.gif);"><img
                                                        src='<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/more0000.gif'
                                                        alt='' id='MoreHandle'
                                    ...
                                    <td width="100%" style="background-image : url(<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/emptyTabSpace.gif);"><img
                                            src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/blank000.gif"
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                    ...
                                    <tr>
                                        ...
                                        <td class="welcome" style="padding: 0px" align="right" width="20"><img
                                                src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/searchSe.gif"
                                        ...
                                        <td class="search" nowrap>&nbsp; <input type="hidden" name="mod"
                                                                                ...
                                                                                src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/searchBu.gif"
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td valign="top" style="width: 10px;"><img
                                ...
                                name="HideHandle"
                                src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/hide.gif" alt="h"
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" width="160">
                                    <tr>
                                        <td style="padding-right: 10px;">
                                            ...
                                            <img src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN ['theme']?>/images/blank001.gif" alt=""
        ...
        <tr>
            <td colspan="3" class="aboveFooter"><img alt=""
                                                     src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN['theme']?>/images/blank000.gif" width="1"
    ...
    <div style="text-align:center"><small>
            <a href="http://flatnux.sugarforge.org" onclick="window.open(this.href);return false;"><img border="0" alt="" src="<?php echo $_FN['siteurl'];?>themes/<?php echo $_FN['theme']?>/images/poweredb.png" /></a>
            <br />
            <small>
                <?php
                echo FN_HtmlCredits();
