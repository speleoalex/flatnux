...
function fm_Browse($dir)
{
    ...
    echo "<div class=\"fnfilemanager_navbar\" style=\"\">";
    //------------------view mode---------------------------------------------->
    echo "<div style=\"position:absolute;right:0px;top:0px;border:1px solid #dddddd\">";
    if ($viewmode== "")
    {
...
// BARRA NAVIGAZIONE --------------------<
    ...
    $bgcolor="#dadada";
    echo "<div class=\"fnfilemanager_listheader\">";
    echo "\n<table style=\"\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">";
    echo "\n\t<tr style=\"\">";
    $a=$order== "name" ? $html_imgdown : "";
    $cl=$order== "name" ? $bgcolorselect : $bgcolor;
    echo "<td style=\"width:".(_SIZE1 - 1)."px;\"><div ><a href=\"".fm_Link(array("order"=>"name"))."\" ".fm_StyleDiv(_SIZE1 - 1)." >";
    ...
    // TITOLI --------------------<
    // CONTENUTO -------------------->
    echo "<div style=\"background-color:#ffffff;border:1px inset;height:100%;overflow:auto;\">";
    if (!is_readable($dir))
...
";
    ...
    else
    {
        ...
        if (is_writable($dir) && FN_UserCanEditFolder($dir))
        {
            ...
            style=\"clear:both;float:left;background-color:#ffffff;margin:4px;border:1px solid #dadada;padding:0px;height:133px;width:112px;text-align:center;overflow:hidden\">";
    ...
    if (is_writable($dir) && FN_UserCanEditFolder($dir))
    {
        ...
        echo "<div id=\"fmformnew\" style=\"display:none;\" >";
