...
//[it]Abilita i commenti {1=SI,0=NO}
//[i18n]enable comments {1=yes,0=no}
$config['enablecomments'] = 1;
//[it]Abilita i voti {1=SI,0=NO}
//[i18n]enable ranks {1=yes,0=no}
$config['enableranks'] = 1;
...
$config['table_rules'] = "";
//[i18n]default view mode {list=list view,icon=icon view}
$config['default_view_mode'] = "icon";
...
$config['permissions_records_groups'] = "group1,group2";
//[i18n]permissions edit groups
$config['permissions_records_edit_groups'] = "group1,group2";
//[i18n]enables data history {1=yes,0=no}
$config['enable_history'] = "0";
//[i18n]enables rss {1=yes,0=no}
$config['enable_rss'] = "1";
