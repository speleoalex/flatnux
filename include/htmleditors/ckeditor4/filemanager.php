...
// link to local section ------>
            ...
            {
                $html = "<div style=\"font-size:12px;line-height:12px;padding:0px;bottom:12px;height:12px;display:block;width:100%;border:0px;border-top:1px solid;\">" . FN_i18n("link to local page", false, "Aa") . ": 
...
// link to local section ------<
        ...
        function fmck_UploadFile($dir)
        {
            ...
            else
            {
                ...
                {
                    FN_Alert(FN_i18n("file not created"));
                }
                else
                {
                    echo $file_clean;
